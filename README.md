...
- You will need to use [PuTTY](https://github.com/rm511130/TAS-Workshop/blob/master/PuTTY_and_SSH.md) to access a Ubuntu VM (public IP address) using a `.ppk` private-key file.
- To download [`fuse.ppk`](https://raw.githubusercontent.com/rm511130/TAS-Workshop/master/fuse.ppk) you can install and use [wget](http://downloads.sourceforge.net/gnuwin32/wget-1.11.4-1-setup.exe) in a PowerShell window.
```
help wget
cd ~\Downloads
wget https://raw.githubusercontent.com/rm511130/TAS-Workshop/master/fuse.ppk -Outfile fuse.ppk
```
...
- If you need help installing or using PuTTY with [fuse.ppk](https://raw.githubusercontent.com/rm511130/TAS-Workshop/master/fuse.ppk) check these [detailed instructions](https://github.com/rm511130/TAS-Workshop/blob/master/PuTTY_and_SSH.md).
...
```
cd ~/Downloads
wget https://raw.githubusercontent.com/rm511130/TAS-Workshop/master/fuse.pem
