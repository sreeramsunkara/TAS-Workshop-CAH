...
- To download [`fuse.ppk`](https://github.com/rm511130/TAS-Workshop/blob/master/fuse.ppk) you can install and use [wget](http://downloads.sourceforge.net/gnuwin32/wget-1.11.4-1-setup.exe) in a PowerShell window.
```
help wget
cd ~\Downloads
...
- If you need help installing or using PuTTY with [fuse.ppk](https://github.com/rm511130/TAS-Workshop/blob/master/fuse.ppk) check these [detailed instructions](https://github.com/rm511130/TAS-Workshop/blob/master/PuTTY_and_SSH.md).
